                        ...
                        $.ajax({
                            ...
                            for (i=0; i < data.length; i++)
                            {
                                ...
                                if (etageLocal == -1){
                                   ...
                                   elements += '<li><a href=\"javascript:afficherMarqueur(\'' + positionLocal  +'\'' + ',' + etageLocal + ',' + '\'<strong>' + nomLocal + '</strong><br>' + message + '\')">' + '<h3 class="nomLocal">' + nomLocal + '</h3><br><h6 class="etage">' + etageLocal +'er étage'+ '</h6><span class="codeLocalQ">Q' + numeroLocal + '</span><i class="material-icons pull-right">&#xE55E;</i></a></li>';
                               }
